...
## [20.0.0](https://github.com/GuillaumeDesforges/codecompanion.nvim/compare/v19.7.0...v20.0.0) (2026-03-29)


### ⚠ BREAKING CHANGES

* **adapters:** claude code ACP requires `claude-agent-acp` ([#2779](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2779))
* **tools:** change api for handler params ([#2740](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2740))
* rename `variables` to `editor context` ([#2719](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2719))
* **tools:** remove `list_code_usages` tool ([#2693](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2693))
* new diff ([#2600](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2600))
* defaults become presets ([#2497](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2497))
* **workflows:** `is_workflow` replaces `strategy = workflow`
* **workflows:** `opts.is_workflow` defines a workflow ([#2487](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2487))
* `strategies` are now `interactions` ([#2485](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2485))
* remove old system prompt config option ([#2484](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2484))
* rename `catalog` to `builtin` ([#2482](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2482))
* **prompt_library:** prompts can be markdown and exist in directories ([#2471](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2471))
* `child_window` to `floating_window` ([#2452](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2452))
* **tools:** `user_confirmation` is now `require_confirmation_after` ([#2450](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2450))
* **tools:** `requires_approval` is now `require_approval_before`
* **adapters:** `condition` is now `enabled`
* remove workspaces ([#2446](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2446))
* remove deprecations ([#2445](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2445))
* **chat:** pins and watchers are now sync_all and sync_diff ([#2444](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2444))
* **chat:** rename memory to rules ([#2440](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2440))
* **chat:** pass adapter as arg in `:CodeCompanionChat` ([#2437](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2437))

### Features

* **acp:** add acp session events ([#2938](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2938)) ([754979b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/754979bd326ab144b4a30dc99049518878efe256))
* **acp:** add augment code (auggie) adapter ([#2352](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2352)) ([7ca4e49](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/7ca4e4928cc14187abfc2144c9d7bfcf531bcf15))
* **acp:** add codex support ([#2236](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2236)) ([2f7a088](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2f7a08813914e07c7f1928128314aa1b27c40770))
* **acp:** add copilot-cli ([#2896](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2896)) ([4c381c2](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4c381c2ae28f246319fe4fc5fad856360d1113ad))
* **acp:** add Cursor CLI adapter ([#2907](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2907)) ([d5551b1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d5551b1aac60e164fb569eba422ea9b65cd2d6f4))
* **acp:** add more adapters ([#2394](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2394)) ([6dd3236](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6dd32360a76dca98e62514be70b42607e6fadac8))
* **acp:** add restore event on successful `session/load` ([#2950](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2950)) ([78203cc](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/78203ccaa36469b4a212123c7d532e2367ad9dd4))
* **acp:** add session modes ([#2331](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2331)) ([1d98b9e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/1d98b9e91107898b055ea54b4f24dad9a24d84ed))
* **acp:** add support for `session/list` and `session/load` ([#2910](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2910)) ([d782bd1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d782bd1cc5fa365f0dc8a7cdc5dcb66877ab7212))
* **acp:** add support for slash commands ([#2260](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2260)) ([b47e2aa](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b47e2aa0873a5ea9ec96685a6e462599d8b823a4))
* **acp:** add tool request approval event ([#2870](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2870)) ([d87556a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d87556a843c56bedbfd941d08bf795d2c71cc06a))
* **acp:** can specify default mode ([#2901](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2901)) ([6229e8f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6229e8fb75066878352a0bafd685598a78d907c8))
* **acp:** select models and improved config ux ([#2641](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2641)) ([c52042d](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/c52042d4ee2ba21fcb072678919735e013fb7943))
* **acp:** support `session-info-update` ([#2911](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2911)) ([03cab40](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/03cab4077d1b91af78edb58afc5954bd67004b28))
* **acp:** support all plugin diff providers ([#2311](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2311)) ([ee7f44c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ee7f44ca9c2f22a7b82139719856a2f3d68efd49))
* **adapters:** add cline_cli acp ([#2931](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2931)) ([34ffd4b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/34ffd4b9f96726b061dee57cb57380f06813ee0a))
* **adapters:** add Gemini 3 Flash to Gemini ([#2548](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2548)) ([6db10c1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6db10c1d38f09194cff6760717bc8f907068f20c))
* **adapters:** add Mistral Vibe support via ACP ([#2728](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2728)) ([339bce8](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/339bce8ffc057dcd5af4832ec0f4f0fc24ca773c))
* **adapters:** add new Anthropic models ([#2775](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2775)) ([a6e9228](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a6e922806d9e6abf0b9bbf2c753a36f04a097da1))
* **adapters:** add support for Claude Sonnet 4.5 ([#2207](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2207)) ([e629759](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e629759ae6960418244f90b037f584323b3bc05c))
* **adapters:** add support for Gemini 3 in Copilot ([#2419](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2419)) ([7686e3a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/7686e3aa5edfc7ab03487239a9c1fa757e81cc97)), closes [#2413](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2413)
* **adapters:** add support for gemini-3 ([b7dc2b1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b7dc2b19371fa20913b4cc5f7867741b35d3467e))
* **adapters:** add support for gemini-3 in the gemini adapter ([#2411](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2411)) ([b7dc2b1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b7dc2b19371fa20913b4cc5f7867741b35d3467e))
* **adapters:** add support for Kiro via ACP ([#2729](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2729)) ([1c9a92c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/1c9a92c3a30115a1236f19df3bced12481f4feb8))
* **adapters:** add support for OpenAI's Responses API ([#2213](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2213)) ([a3e55ba](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a3e55baea86cc961fd4a172384d05c2f2d4c1446))
* **adapters:** add tool support to Mistral ([#2278](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2278)) ([2a2b294](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2a2b29410ddb4c2a5f72a2629c2180130ed9d4bb))
* **adapters:** add verbosity param to OpenAI Responses ([#2243](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2243)) ([94f9120](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/94f9120387aa80832c4f164f60a6804a27b9479c))
* **adapters:** allow hiding of acp adapters ([#2086](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2086)) ([aa7c937](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/aa7c937ac9f73e061da74dec6ab5f1fc6909dd37))
* **adapters:** amend [#2729](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2729) to add Kiro adapter ([#2730](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2730)) ([dfb0ca9](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/dfb0ca928c439b65b1ac33758d90a9bc49c72138))
* **adapters:** change gemini default to 3.1 pro ([#2829](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2829)) ([758e3fb](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/758e3fbb357a49ba823d6498eb745b0deec64abc))
* **adapters:** copilot can dynamically set max tokens ([#2429](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2429)) ([d348080](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d348080e39d5f184a83cdd5a549ad6037be4172b))
* **adapters:** Copilot now has max_context_window_tokens ([#2516](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2516)) ([8e81351](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8e813517c537007c784b2702609b244712433e1f))
* **adapters:** improve caching in anthropic and add to copilot ([#2798](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2798)) ([66aaa6a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/66aaa6ae4c88434fccef7a7eb34bcaf2058c9b0b))
* **adapters:** mistral can now reason ([#2377](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2377)) ([4c37295](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4c37295e111eb3534a5cd1391c5a65ce3c4cb3c8))
* **adapters:** respect OLLAMA_HOST env var for remote connections ([#2878](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2878)) ([45b31a9](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/45b31a9d818007d978bd7d8007bbed4bfbaa5d78))
* **adapters:** show copilot multipliers and refactor changing adapters ([#2427](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2427)) ([e400396](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e40039647faf9eba740fa0656dceeb14fb91a725))
* **adapters:** support extra fields in OpenAI adapter ([#2359](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2359)) ([9cc2933](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9cc2933a735a238c586c267e07f4992f039c1027))
* **adapters:** update Anthropic models ([#2556](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2556)) ([4790ea4](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4790ea4e413cd828165994a4dc023da728873fa1))
* **adapters:** use mcp server config with acp adapters ([#2766](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2766)) ([6433926](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/64339262bfdc78003f5e1a227792bd2c2228c854))
* add background interaction ([#2184](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2184)) ([f746584](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f7465847dc23c81d2fb3d0d1f366191ed799fae9))
* add MCP client ([#2549](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2549)) ([a09c0ac](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a09c0ac3aafe0ac39c0b88da341ad52b77706134))
* add sonnet-4-5 ([e629759](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e629759ae6960418244f90b037f584323b3bc05c))
* **chat:** :sparkles: add memory ([#2093](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2093)) ([b3fe1b0](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b3fe1b020262ef970e9bcd43f0faec856a5bd472))
* **chat:** add `on_before_submit` callback ([#2760](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2760)) ([2b21995](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2b21995c4460b2b58d842b343c810483797f2907))
* **chat:** add floating diff layout with focus effects ([#2016](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2016)) ([d556e1b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d556e1b2c0ac85037a589ae15dae461255297bc1))
* **chat:** add new editor context items ([#2780](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2780)) ([6e1bad4](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6e1bad424bd769a192e6fa5f220024b39d5ab8b6))
* **chat:** auto add mcp tools ([#2764](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2764)) ([49223a4](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/49223a4b9056b76283619b9461912d62c391b3d3))
* **chat:** automatically generate chat descriptions ([#2462](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2462)) ([7962553](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/796255361e62abf2e765135bdf608a718777b49b))
* **chat:** better tool cancelling ([#2153](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2153)) ([119bd84](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/119bd84413611380045994d6ab5c2e077ed546c5)), closes [#2149](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2149)
* **chat:** change system prompt date and make configurable ([#2899](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2899)) ([57d3f1b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/57d3f1bd08d1f37bf483daf3a6ff72e76280553a))
* **chat:** new agent mode with group system prompts ([#2786](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2786)) ([a4e64ae](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a4e64ae9b9c5c315d8af93e980d8eed4cb8ca92a))
* **chat:** pass adapter as arg in `:CodeCompanionChat` ([#2437](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2437)) ([25127ef](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/25127ef5b93cfd5070163d1deb86d167922b2b1e))
* **chat:** pass context to chat interaction when prompt is function ([#2762](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2762)) ([c079e95](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/c079e95c0ec9f1371dadc91a1a5eaf24b6e6c4e3))
* **chat:** rules path can be dirs and glob patterns ([#2509](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2509)) ([1b23363](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/1b23363f50ffc5558fb2f79f799e49228195ff6f))
* **chat:** support hidden chat buffers on creation ([#2723](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2723)) ([e45da8f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e45da8fbca30623364feced8e7aab583533de40f))
* **chat:** system prompt is modularised ([#2322](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2322)) ([50ea30e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/50ea30ec76e1a2695164991a7480f0fa0662e9db))
* **chat:** system prompt to include filepath ([#2580](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2580)) ([24a48e4](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/24a48e49792f28f35cb2343a298f6397f95ffe16))
* **ci:** add a container definition to run the CI toolchain ([#2794](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2794)) ([4540978](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4540978540bd2167699643debb645c7b3d5b5988))
* **cli:** add filetype to terminal buffer ([#2894](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2894)) ([20d45ca](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/20d45ca9912a886460a07109b3b70e4118eac6f1))
* **cli:** new interaction type ([#2836](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2836)) ([b3760b9](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b3760b96aa9af194fae2ed89f923afb4b7951049))
* **cli:** persistent prompt, history, slash commands ([#2922](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2922)) ([e91c035](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e91c03573ad466ce25a273694bf51b2cbb633f85))
* **cmds:** can toggle with the adapter param ([#2535](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2535)) ([19ac06a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/19ac06a849778d002c93ffc9cb90d07120a9b1a7)), closes [#2528](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2528)
* **cmds:** pass model to `:CodeCompanionChat` ([#2466](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2466)) ([b7c750c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b7c750c68617c3e6beba1b132741c4c5170dcf8e))
* customize slash_command, tool and variable prefixes ([#2710](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2710)) ([4ceb4fd](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4ceb4fd9a5eeff927aded5364763b4803533d5bb))
* improve how buffers are watched ([#2897](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2897)) ([f08d411](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f08d4113fce494211b3eee7e7e4c86ac42d8b689))
* **inline:** add keymap to stop request ([#2426](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2426)) ([723ca0e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/723ca0eaa13b0e4c87c30c1416f6ff81b87aeae4)), closes [#2420](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2420)
* **keymaps:** use `false` for disabling keymaps ([#2264](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2264)) ([982f80f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/982f80fa44117ebe5b19218bade76536d94119d4))
* new diff ([#2600](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2600)) ([27a2224](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/27a222455333482a599ef364a03dc296390b6765))
* per-project configuration ([#2778](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2778)) ([ac042ea](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ac042eacf1a76673a87828461fb126d510576982))
* **prompt_library:** add user prompt to context ([#2864](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2864)) ([bade403](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/bade4034395d327f1fd3defd34cce4793e412a27))
* **prompt_library:** can enable/disable prompts ([#2759](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2759)) ([e05e698](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e05e6987bde71158650b9ce99489183852dfbdc4))
* **prompt_library:** can ensure no tools or mcp_servers are added to chats ([#2785](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2785)) ([d8a3540](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d8a3540db8390c45db0e2b7c26bd90e26169aaa6))
* **prompt_library:** prompts can be markdown and exist in directories ([#2471](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2471)) ([d14a50b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d14a50bdd0a78c92a8f2985b52e8a0a31c199eab))
* **prompt_library:** prompts can contain tools and MCP servers ([#2725](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2725)) ([5491de9](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/5491de964ea750ecc5f6bacd4c10452cf8155740))
* **prompts:** add code to context table ([#2523](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2523)) ([42d28cb](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/42d28cbed8b61c5c144d0adf06553c26b88439e4))
* **prompts:** work with nested dirs ([#2694](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2694)) ([c86466e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/c86466e0af8e7aa5256ed851b2944b8f8067dbcd))
* **rules:** default_rules can be a function ([#2479](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2479)) ([04f39a3](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/04f39a333415084688027bd44ecc1db7e4066b07))
* **slash_cmd:** add `/compact` ([#2385](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2385)) ([dbc54cb](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/dbc54cb86bc169ab49a510786ef8cc4d10293c3b))
* support an adapter's built-in tools ([#2307](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2307)) ([462197a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/462197a603817ef91471266e1476464803f65224))
* **tools:** :sparkles: new `insert_edit_into_file` tool ([#2219](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2219)) ([a4f8505](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a4f850591970d5ab4e51951b08ddb0c5c239b210))
* **tools:** add callback to allow modification of tool output ([#2872](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2872)) ([2e1bbed](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2e1bbedf9de85a256b12f3636dbaf153cca450de))
* **tools:** add cmd_runner factory and rename `cmd_runner` to `run_command` ([#2754](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2754)) ([0fa447e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/0fa447ed1f157ad4529c4bef63206bc54663db64))
* **tools:** add delete tool ([#2345](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2345)) ([ae93605](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ae936052d74454e941c39201a6d9aeaf55675c21))
* **tools:** better approvals ([#2569](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2569)) ([837514b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/837514bae59ef25c3d86f54d2c748e6a239714c3))
* **tools:** better tool approvals and removal of `vim.fn.confirm` ([#2917](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2917)) ([0c361ec](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/0c361ec27738eb7f2e39a071b85b950f68244fb6))
* **tools:** can send rejection message and always approve/accept ([#2249](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2249)) ([3e8ab76](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/3e8ab76992ccc918699e6779f2a889201b611b89))
* **tools:** fire an event when tool approval is requested ([#2783](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2783)) ([0d2904d](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/0d2904df49b7ab8dfc1a1ecbbe100f9a157ccdb1))
* **tools:** include tool arguments in events ([#2724](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2724)) ([f862c5f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f862c5f4cb8cbbd6e72a7a4f87cf3437eafb0503))
* **tools:** memory can have whitelisted paths ([#2898](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2898)) ([8eae866](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8eae86632268e7bd2b5cdbff2815c9b16e3e1a7f))
* **tools:** provide ctx arg to tool system prompt ([#2838](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2838)) ([d96c833](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d96c83350dee7fe25b1a82e9ab2c0f906c552f32))
* **ui:** auto chat dimensions ([#2753](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2753)) ([b36b76e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b36b76e215934885c6b7e98c22bbc68c4e610538))
* **ui:** better cursor scrolling in the chat ([#2670](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2670)) ([6657e6f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6657e6fd594d3c9f6dd3ab9e26a0c76b8e7082e1))
* **ui:** customize chat buffer window config when opening ([#1678](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/1678)) ([3a10ec9](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/3a10ec951a0285f149a6f76ba3cf544b3e4b7c63))
* **ui:** don't stack extmarks in ACP chats ([#2902](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2902)) ([ecb41c1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ecb41c17747334315ec0f7777eeace102c5c9db0))
* **ui:** inline diff in chat ([#2934](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2934)) ([d5fd611](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d5fd611dfb0be28e047bf89235f3b28ebd22b58b))
* **ui:** make acp tool calls cleaner ([#2904](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2904)) ([cc0d298](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/cc0d298b6b7bdbdcfe48f7e70deb0e6215fe4d32))
* **ui:** open-in-tab chat/inline option ([#2792](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2792)) ([57d5b7e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/57d5b7e3deabfe29cf4c554de75815fa334ce7da))
* **ui:** show title in floating window ([#2750](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2750)) ([f977c56](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f977c56129d6178cd96047459b9709a8fd99140f))
* **ui:** snacks picker shows previews in action palette ([#2295](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2295)) ([41305ff](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/41305ffa613f3d210ef5418da2ea42d9af29e181))
* **ui:** streamline ACP output in the chat ([#2353](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2353)) ([78ab53d](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/78ab53dc17ef5d158e06377fe34fc91e8e2f0dba))
* **workflows:** can change adapter on each prompt ([#2146](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2146)) ([8d55059](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8d55059b63bcf53e8b4d3d0885c37b2282d6fa2d))


### Bug Fixes

* **acp:** better error handling ([#2399](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2399)) ([ceaca96](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ceaca960b8404f6d9ff758b77c8f1df01557656b))
* **acp:** claude code command shouldn't need npx ([#2288](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2288)) ([5734709](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/5734709a37ee6436597912893fb326a1891a9288)), closes [#2286](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2286)
* **acp:** close all open connections on exit ([#2292](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2292)) ([73ecd3a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/73ecd3a67cba61744ea8e3194ef464054025573c)), closes [#2286](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2286)
* **acp:** ensure jobs can be cancelled ([#2225](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2225)) ([a61dfc1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a61dfc1b916f4fabe482a68d106b7876800b371b)), closes [#2223](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2223)
* **acp:** file reads/writes with empty sessionId ([#2947](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2947)) ([d4532d8](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d4532d89fe23a59b2f5e06f58669ab548be44b86))
* **acp:** fire event when calling /mode command ([#2656](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2656)) ([8ebbcc2](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8ebbcc27d20e9ac6e7491de6ef9aac1fbf6277a2))
* **acp:** fix claude always outputting tool content ([062126b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/062126b178783834c4bccc871cb3b200cc5aa3b9))
* **acp:** handle adapter returning vim.NIL instead of lua:nil ([#2266](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2266)) ([5efcc8f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/5efcc8f401061caf022bc54392b1ad968717220e))
* **acp:** kimi cli authentication failure ([#2711](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2711)) ([69c26d2](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/69c26d2eb2f14361844af0ba36ae13a4b60dcc2d))
* **acp:** prevent auto-close of mini_diff provider ([#2379](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2379)) ([a8c696d](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a8c696d1fc4268085e4306d54af39b07be884b17))
* **acp:** protect against msg._meta being nil ([#2366](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2366)) ([ca87f13](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ca87f13b7559257f5aa91e4fcd1326a61311be13))
* **acp:** race condition during initialization ([#2300](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2300)) ([bcd4f84](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/bcd4f84598342c08564740417ef6b2d7ce0b77bf))
* **acp:** reload buffers after edits ([#2869](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2869)) ([972ca95](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/972ca950e0e432d0fa6fa4a585b6005db44e94c8))
* **acp:** show urls in tool output ([#2403](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2403)) ([32dd2da](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/32dd2da2bc1b360676c32ef741d8d63052a8edbd))
* **acp:** terminate processes correctly ([#2949](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2949)) ([9553570](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9553570146adf37fac501863d0cc5f010616c8a5)), closes [#2944](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2944)
* **adapters:** anthropic sending empty messages ([#2700](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2700)) ([2245532](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2245532d204e6a5a54abdc369f8b814689bf98c2))
* **adapters:** anthropic token count fixes ([#2624](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2624)) ([3c1b2e3](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/3c1b2e31ada2e25932fbaab6917db23c313084db))
* **adapters:** check for nil in `openai_responses` ([#2662](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2662)) ([e22c043](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e22c04336b5c56e3839bfebd6d88944f014f4b30))
* **adapters:** copilot log error ([#2663](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2663)) ([6fa8338](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6fa8338b4332d57c153b40205613c3c56736a255))
* **adapters:** copilot now supporting completions endpoint ([#2284](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2284)) ([9741526](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9741526b5efa8f1f313c8d41bbd7f1862c7d75d5))
* **adapters:** copilot stats forces oauth token fetching ([#2520](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2520)) ([2cf85e3](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2cf85e3fe63572e3a1c2be32c2ffb5b7bb0d18ab))
* **adapters:** copilot stats when using free account ([#2388](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2388)) ([3d533fa](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/3d533fa987dc73f39aba02b8f043caf36380f78a))
* **adapters:** copilot supported endpoints ([#2691](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2691)) ([dd98466](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/dd98466a893abf499fbd69ab9526b2da7c094fb8))
* **adapters:** ensure Copilot models have correct capabilities ([#2638](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2638)) ([b4d8040](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b4d8040079dbbeea3d87fc594f6caa79b94fc427)), closes [#2637](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2637)
* **adapters:** fix claude-code always outputting tool content ([#2169](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2169)) ([062126b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/062126b178783834c4bccc871cb3b200cc5aa3b9))
* **adapters:** gemini reasoning ([#2572](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2572)) ([96b15d4](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/96b15d47561469f318c03f1ce11498340513c1ea)), closes [#2571](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2571)
* **adapters:** gemini system prompts ([#2530](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2530)) ([247ab70](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/247ab7022c4fb150c9f35138c44092f2f414a98e))
* **adapters:** increase timeout for env var cmds ([#2601](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2601)) ([c265e25](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/c265e25786ca0f2d1a07b4ceaa120ecbafcc5204)), closes [#2594](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2594)
* **adapters:** inline output for `openai_responses` adapter ([#2256](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2256)) ([4437cb0](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4437cb033ea2245981a9c55c268dd1fd5b710c61)), closes [#2252](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2252)
* **adapters:** openai_responses images merged as text ([#2733](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2733)) ([bb571be](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/bb571be895f715c6e3ce3c42cdb2059408725246))
* **adapters:** use custom headers in Ollama get_models ([#2644](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2644)) ([9079ff9](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9079ff9244d77eea3c0c5b63ce092c45b0eaa8d2)), closes [#2642](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2642)
* **chat:** `after/ftplugin/codecompanion.lua` settings now work ([#2251](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2251)) ([87a2f78](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/87a2f78767a03707fa85f108d374a320ff000f02))
* **chat:** add context via visual selector ([#2622](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2622)) ([bae898d](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/bae898dd0dcfffd03a78856e4df57cbe78e8ac79))
* **chat:** buffers with duplicate short_paths ([#2665](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2665)) ([e0780fa](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e0780fa9fda504ffb89307cabcb6cbe1ce8eb60c))
* **chat:** changing adapters and models ([#2472](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2472)) ([663d53c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/663d53cd1a05a699c7d2741d09369c15f12b1e10))
* **chat:** chatting with rules ([#2809](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2809)) ([8d9357c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8d9357c4bfa08c793fe641edd022fb47323009fa))
* **chat:** claude code diff and fs/read_text_file fixes ([#2126](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2126)) ([b76621b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b76621b1ced981f0ea358b9515e93bf86bb5acb5))
* **chat:** clip claude code tool output ([#2134](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2134)) ([b890561](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b8905612ccb08d6b4b166dd2508a458c33db7c84))
* **chat:** conditionals for slash commands and tools ([#2336](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2336)) ([8719211](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8719211b896c48ffd9c288efaf0d4a47fb17cd71))
* **chat:** debug window error with ACP adapters ([#2291](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2291)) ([43586ed](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/43586ed845489f052469bdbc2bbdc3b7f13587b6))
* **chat:** debug window with acp adapters ([#2141](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2141)) ([35c591f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/35c591f457895f28f244684fa7e744fa3c9438c0))
* **chat:** default system prompt uses safer date format ([#2091](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2091)) ([f97108b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f97108b9e9b13fe5df7e7e00fb1612ecb56aac34))
* **chat:** don't add duplicate memory ([#2131](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2131)) ([669bbdf](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/669bbdf0940029a08074292d1f31f945af18d0cf))
* **chat:** don't assign last_chat to hidden chats ([#2749](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2749)) ([8ba7c60](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8ba7c60632f501a22a60f27fb49001c13aadd138))
* **chat:** editor context not displaying in the UI ([#2801](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2801)) ([30859c0](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/30859c04789b991af65e0ae41439c56d185429b5))
* **chat:** enable reasoning to be disabled for acp ([#2848](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2848)) ([5e31b99](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/5e31b9967da0e085bc06b468ea48c8293067fabd))
* **chat:** force memory to be added via slash command ([#2140](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2140)) ([8899c27](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8899c278c2e34108aec573b5f782a6bb7915d83c))
* **chat:** improve handling nested tables for the debug window ([#2554](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2554)) ([532ccbf](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/532ccbf22c166e084a867fcd2830dc4d9612d289))
* **chat:** infinite loop when toggling chat ([#2145](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2145)) ([30fec3a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/30fec3a084832d89cddb8d45827ff061e3564993))
* **chat:** markdown parsing of images ([#2926](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2926)) ([4830417](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4830417353a5430002403f6751b027a56b595863))
* **chat:** omnifunc completion ([#2275](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2275)) ([b1937ad](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b1937ad400305860558c0adf6bd10ae7892fff26)), closes [#2270](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2270)
* **chat:** pass in opts to toggle ([#2143](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2143)) ([971e584](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/971e584c29ea04aca189188378a0c9b10a1c531b))
* **chat:** preserve prompt library system prompts ([#2433](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2433)) ([ccfdc47](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ccfdc473c375a926c47923bf251ce9fc0f817843))
* **chat:** prevent duplicate editor context ([#2771](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2771)) ([cfa96a3](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/cfa96a3585234799ef26addf48cd707686521f6e))
* **chat:** prevent duplicated rule files ([#2837](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2837)) ([1913b5a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/1913b5aa05745bca90d7912c76ed118f1744a620))
* **chat:** prevent readfile error on directories when using edit_tracker ([#2269](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2269)) ([9d49b75](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9d49b758de4a3f2c4c2e8a0561e6d126e47dad85))
* **chat:** prevent tool groups being added twice. ([#2773](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2773)) ([796a339](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/796a339a75f0a7804f83b6b567c322cf600dfc36))
* **chat:** recursive chat open calls ([59a29bd](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/59a29bd5aea9d82489b13405895b0eead990c49b))
* **chat:** remove images from title prompt ([#2586](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2586)) ([274b2c6](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/274b2c69ea17d7f417999b132d81d63eb2cdb73f))
* **chat:** safely set undolevels ([#2123](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2123)) ([5807e04](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/5807e0457111f0de267fc9a6543b41fae0f5c2b1))
* **chat:** show tools on chat creation ([#2929](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2929)) ([e010179](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e010179d64538ce1fd88310d08b4697b356b17c8))
* **chat:** stop duplicated context with `:CodeCompanionChat Add` ([#2402](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2402)) ([14b5782](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/14b57823943652da77b7fbc0964733cb9ff14606))
* **chat:** throw error with get_parser in nightly builds ([#2887](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2887)) ([41bec16](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/41bec16c399393186c2ff0e2cbcb0a56623d402b))
* **chat:** undolevels leaking outside of codecompanion ([#2234](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2234)) ([ebce7c7](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ebce7c77585d421ca428233fb480c5e3a2873f50))
* **chat:** use file contents to detect filetype for symbols ([#1827](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/1827)) ([ee1c317](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ee1c317d4ac468f8c5938d7e954e65cb037757e7))
* **chat:** watched buffer diffs should have context id ([#2410](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2410)) ([9b38615](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9b38615913835c19c82c0296f53cdb1533dc5640))
* completion args ([#2739](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2739)) ([98818d2](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/98818d2a9e048ac917f81f9b5ffd562fc3bc317c)), closes [#2707](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2707)
* **completion:** acp and slash commands with nvim-cmp ([#2889](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2889)) ([b9a4af6](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b9a4af6d1d9210bde624f8919cacbd45fd85b186))
* **completion:** coc.nvim provider detection, execution, and highlighting ([#2868](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2868)) ([7e78668](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/7e78668214a87c707bdd3a5a1f9ceb2e20451c06))
* **config:** map strategies to interactions ([#2493](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2493)) ([2fd3306](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2fd3306246fed987c46484d18cab2687e6d80571))
* **copilot:** handle "quota exceeded" error ([#2430](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2430)) ([d8fbcfe](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d8fbcfe21925c2e3a7215fbcb7eb98a7de48fa7c)), closes [#2416](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2416)
* **diff:** clear auto commands for inline integration ([#2709](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2709)) ([f929110](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f9291106861c3325b257138acccef7ccabfcac5d))
* **diff:** clear winhighlight properly when cleanup diff ([#2396](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2396)) ([c33f6c0](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/c33f6c0aa187054806ad7db43978d6bdef91f9e7))
* **diff:** fire detach when inline diff completes ([#2237](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2237)) ([a189018](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a189018721a692dabdefbf1e0f58971c6204a7d7))
* file format normalization on Windows ([#2550](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2550)) ([97ee970](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/97ee9705e1584b44bd74a799dba66579732a069a))
* **http:** handle nil data in HTTP callbacks ([#2558](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2558)) ([43efc50](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/43efc50ed4320b324201f096456cd1800ea5d5e4))
* **inline:** error in stop kepmap handler ([4918653](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4918653e98aba390b97dfff1a6c5f11d3beb97fa))
* **inline:** error in stop keymap handler ([#2840](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2840)) ([4918653](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4918653e98aba390b97dfff1a6c5f11d3beb97fa))
* **inline:** leave visual mode after making inline request ([#2562](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2562)) ([bdf697d](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/bdf697dae74de9a23b8b1842183261f2f538bb87))
* **inline:** parse adapters ([#2069](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2069)) ([12c617a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/12c617a969f53738f1126a389e8f72f4f754f6c0))
* invalid buffer causing errors in markdown files ([#2362](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2362)) ([3e02000](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/3e02000a14847aa49a90c297633d4be2f03702bc)), closes [#2344](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2344)
* pattern escape context ([#2532](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2532)) ([94f62bf](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/94f62bfc4e6333d0b039198a492913533d25946b)), closes [#2525](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2525)
* **prompt_library:** sort user's lua prompts ([#2841](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2841)) ([ed36794](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ed367944ece02d0ab2a2552ba3ad0b092f1a2144))
* **prompt_library:** use vim.system for commit messages item ([#2315](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2315)) ([ed9940f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ed9940fe10fab7b7181b43293c70d287ba5ef231))
* **prompts:** allow symlinks for Markdown prompt files ([#2633](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2633)) ([b1f2aaf](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b1f2aaf9efe4251b4c77f82ded1cd9e33a025b42))
* **prompts:** can comment out frontmatter ([8ec7628](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8ec76289580e6e656f0827e0760aadbbf04062ad))
* **prompts:** prevent duplicate prompts in action palette ([#2818](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2818)) ([99ec85a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/99ec85a74fa2b8ae17cad4a7b854ef612912c9df)), closes [#2816](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2816)
* **prompt:** tags renamed to be tag ([#2115](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2115)) ([a869f19](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a869f190f627123de8bf97df9e9b5bd6f61645f9))
* **rules:** CodeCompanion rules point to interactions ([#2495](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2495)) ([e88933f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e88933f5804de17345ef268e304cd6f0c3631a32))
* **slash_cmds:** compact prompt is now simpler ([#2488](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2488)) ([07f4232](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/07f4232ecd431065b771b6ead2ac6af169c099e0))
* **slash_cmds:** fetching an image from a URL ([#2245](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2245)) ([e16ebf5](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e16ebf57e3cb09d5ee5e8c3c2acee84e6dc650b8)), closes [#2244](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2244)
* **slash_cmds:** make compact prompt, simpler ([07f4232](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/07f4232ecd431065b771b6ead2ac6af169c099e0))
* **slash_commands:** can load from a module path ([#2370](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2370)) ([47e6e1d](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/47e6e1d24864d2bf8ace8904eff7a41bdf1d3126))
* **snacks:** fix nested picking and add preview. ([41305ff](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/41305ffa613f3d210ef5418da2ea42d9af29e181))
* **super_diff:** align variable names with updated diff hunk naming ([#2218](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2218)) ([0380600](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/03806002044f94f8789b28435efd6d383675ba87))
* **tools:** `cmd_runner` tool on Windows ([#2186](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2186)) ([d5491dd](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d5491dd9a1509c845c52276ad7d42cb5ff0ee550)), closes [#2179](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2179)
* **tools:** add additionalProperties: false recursively in enforce_strictness ([#2790](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2790)) ([e54490a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e54490a55a55c6d83691e172ad3697afc3bab74b))
* **tools:** adjust strict mode and make `insert_edit_into_file` adhere to OpenAI schema ([#2357](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2357)) ([2bd958b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2bd958b58237e42fb8b4e5ec98e5d44e24221b32)), closes [#2356](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2356)
* **tools:** consecutive tool calls ([#2545](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2545)) ([8fa83ad](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8fa83adfb812f70bf241a62e84c539e3216a70e4))
* **tools:** enforce strict mode for openai responses adapter ([#2319](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2319)) ([09e1b9f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/09e1b9f3c22e77739bfbae7ddb9b97aa79f811be)), closes [#2314](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2314)
* **tools:** ensure added tool included in tool system prompt arg ([#2839](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2839)) ([e5643f2](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/e5643f230eea64dae8989f5f0cbcea57225b1b1e))
* **tools:** fetch webpage ([#2320](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2320)) ([d13a74f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d13a74ff2954ca9d5e46f4f782e6dc67a95672c3)), closes [#2318](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2318)
* **tools:** gemini incorrect tool args ([#2629](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2629)) ([848f3de](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/848f3dea824e5483d1bcc1cfb63d7158b81d95f6)), closes [#2620](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2620)
* **tools:** grep_search cannot search patterns starting with `-` ([#2748](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2748)) ([f26671f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f26671fc504c72e9ab1aee511125df30c711a97b))
* **tools:** handle newline correctly for insert_edit_into_file ([#2871](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2871)) ([45dd9e4](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/45dd9e4f6382f19dadd6768bb0e90452848b49fb))
* **tools:** remove globals for better concurrent tool usage ([#2680](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2680)) ([c9d74dd](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/c9d74dd667cf609b4f2064ae7f5471285b5356cb))
* **tools:** send rejection reason to LLM ([#2924](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2924)) ([dfb50b2](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/dfb50b21462b64ae1a917e21e69793dc412d92f2)), closes [#2916](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2916)
* **tools:** show diff in `insert_edit_into_file` when file is not open ([#2350](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2350)) ([6ca8768](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6ca8768ad9aff0d6f46dcf8db576843e519e2035))
* **tools:** Support nested objects in enforce_strictness for OpenAI strict mode ([#2334](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2334)) ([88ddc28](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/88ddc28101ca771f99b3ba7489b5abe831de9a17))
* **ui:** append to existing winhighlight values ([#2166](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2166)) ([5c8ec88](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/5c8ec88568115c4091cca331c4cbc42888cb5dc7))
* **ui:** chat buffer syntax highlighting ([#2192](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2192)) ([4336066](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/4336066619f08dd93b2c8900c542cbb6bac5f18a))
* **ui:** closing floating windows ([#2453](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2453)) ([196e4a4](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/196e4a45a15173a75c36259218aa2232878d0966))
* **ui:** cursor placement after user prompt ([#2813](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2813)) ([a3710ff](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/a3710ff4f10a8f215ace1a4f5f0f881d0c6c4e93))
* **ui:** default to normal mode after applying inline diff ([#2014](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2014)) ([b75615a](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b75615a3064685f02b837b591f648536904bb702))
* **ui:** file edit approval message ([#2939](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2939)) ([8f4a3d3](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8f4a3d3450e2223fec8747465be16a9f821f02b4))
* **ui:** improve ACP tool call output ([#2912](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2912)) ([9827dbd](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9827dbdde55217e7b4185e744eae15f74e9c5e8b))
* **ui:** move between h2 role headers ([#2751](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2751)) ([0d7c46f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/0d7c46f06c2c2649755a4d3c3e3f9c1960dbe43f))
* **ui:** stop duplicate approval messages ([#2943](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2943)) ([9809e46](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/9809e463e786dafb8e0c86093d5648f1fb40769f))
* **ui:** switch to chat tab after closing prev chat ([#2855](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2855)) ([df77d69](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/df77d6911286d8172b3e235c6aba8e736f0053fa))
* **ui:** winbar timing with inline floating diff ([#2512](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2512)) ([8172477](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8172477225edcf73bcebdb0a9a2460287ba94186))
* **ui:** window width is always calculated ([#2708](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2708)) ([517f82e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/517f82e8d04dd1b8a2db4af2c110bd492784ce41))
* use correct config item ([#2195](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2195)) ([7f28c3c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/7f28c3cc3abb116f14281ed4f490929684ffb1e7))
* use scratch buffer for ACP to prevent orphan files ([#2447](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2447)) ([df1e90e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/df1e90e5c166012ecc9c1032a0598394e0aac172))
* **utils:** escape percent signs ([#2743](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2743)) ([42cf6d1](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/42cf6d1637fc8934421fe69745fd01098068ece6))
* **utils:** escape percent signs in placeholder replacements ([#2736](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2736)) ([294eddc](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/294eddccf6672a46961ccf1d4fc84103432dd002))


### Performance Improvements

* **adapters:** make copilot start faster ([#2503](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2503)) ([2adedf7](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2adedf70025617d8dd4cc7f874cff347776cd050))
* **chat:** improve the chat buffer ([#2941](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2941)) ([f0c6487](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/f0c6487a0c0b750b29e7e602ebc8a2062aef0ba2))


### Code Refactoring

* `child_window` to `floating_window` ([#2452](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2452)) ([fdf2d02](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/fdf2d028866835f45fae1e60da423bf7ae91ecc2))
* `strategies` are now `interactions` ([#2485](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2485)) ([2f1c887](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/2f1c887c9496ff72fb2852576fbf0f4305f3a274))
* **adapters:** `condition` is now `enabled` ([cb14c7b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/cb14c7bac869346e2d12b775c4bf258606add569))
* **adapters:** claude code ACP requires `claude-agent-acp` ([#2779](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2779)) ([8a41c79](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/8a41c79c41fa84dcf353b32a790f421204916cf8))
* **chat:** pins and watchers are now sync_all and sync_diff ([#2444](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2444)) ([16cb55b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/16cb55ba6f869e3852663fcb01774f9ab5e17f7c))
* **chat:** rename memory to rules ([#2440](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2440)) ([ba3fd6f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/ba3fd6fc0d38904a2f7f1d42a0f2701cdcf2567d))
* defaults become presets ([#2497](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2497)) ([269c2ca](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/269c2ca3d34c56bb46c010e31c379fa495f6425a))
* remove deprecations ([#2445](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2445)) ([5a4847f](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/5a4847ff10a1e18422080c6f21c34f970e4c088f))
* remove old system prompt config option ([#2484](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2484)) ([0d197f6](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/0d197f62a2f64d5df3f7f99db44fa237bf7c5d97))
* remove workspaces ([#2446](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2446)) ([1a5bed2](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/1a5bed2f1b3cf5f6600743f3758a18d836e7b50a))
* rename `catalog` to `builtin` ([#2482](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2482)) ([d51296b](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/d51296b6d0923bad1cf0acbbee88f11f6515eff2))
* rename `variables` to `editor context` ([#2719](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2719)) ([42ba80c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/42ba80cadf52ca688fb071006fe353a8b4538010))
* **tools:** `requires_approval` is now `require_approval_before` ([7d54837](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/7d548376a1f7600628246adaeea805e935cd2158))
* **tools:** `user_confirmation` is now `require_confirmation_after` ([#2450](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2450)) ([6d7f1bb](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/6d7f1bb63e4262404e35ca7941053e643fac8fbe))
* **tools:** change api for handler params ([#2740](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2740)) ([39ba145](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/39ba145b44b2eebd65699641f12f3e4eafd9514e))
* **tools:** remove `list_code_usages` tool ([#2693](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2693)) ([b57085c](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/b57085c422f39f184a802daaf65a7e52aacc59b9))
* **workflows:** `is_workflow` replaces `strategy = workflow` ([fc1d87e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/fc1d87e52434b7cc203d893e2e35a694499db59b))
* **workflows:** `opts.is_workflow` defines a workflow ([#2487](https://github.com/GuillaumeDesforges/codecompanion.nvim/issues/2487)) ([fc1d87e](https://github.com/GuillaumeDesforges/codecompanion.nvim/commit/fc1d87e52434b7cc203d893e2e35a694499db59b))
